...
module Mapserver
  module MapFileSections
    class Map
      ...
      # @param [Mapserver::MapFileObjects::Layer]
      attr_accessor :layer

      # @param [Mapserver::MapFileObjects::Legend]
      ...
      # @param [Mapserver::MapFileObjects::Projection]
      attr_accessor :projection

      # @param [Mapserver::MapFileObjects::QueryMap]
      attr_accessor :query_map

      # @param [Mapserver::MapFileObjects::ReferenceMap]
      ...
      # @param [Mapserver::MapFileObjects::Scalebar]
      attr_accessor :scalebar

      # @param [String]
      attr_accessor :shape_path

      # @param [Mapserver::MapFileObjects::Symbol]
